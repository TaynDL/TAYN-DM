...
public partial class SettingsWindow : Window
{
    ...
    public SettingsWindow(AppSettings value)
    {
        ...
        NotificationBox.IsChecked = value.ShowNotifications; ScanBox.IsChecked = value.ScanAfterDownload; StartupBox.IsChecked = value.RunAtStartup; DarkBox.IsChecked = ThemeManager.IsDark;
    }
    ...
    private void Save_Click(object sender, RoutedEventArgs e)
    {
        ...
        settings.ShowNotifications = NotificationBox.IsChecked == true; settings.ScanAfterDownload = ScanBox.IsChecked == true; settings.ProxyUrl = ProxyBox.Text.Trim(); settings.RunAtStartup = StartupBox.IsChecked == true; settings.DarkTheme = DarkBox.IsChecked == true; settings.Save();
